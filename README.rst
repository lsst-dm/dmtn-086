.. image:: https://img.shields.io/badge/dmtn--086-lsst.io-brightgreen.svg
...
.. code-block:: bash
   ...
   git clone https://github.com/lsst-dm/dmtn-086
   cd dmtn-086
...
The published technote at https://dmtn-086.lsst.io will be automatically rebuilt whenever you push your changes to the ``master`` branch on `GitHub <https://github.com/lsst-dm/dmtn-086>`_.
